...
class PomTest {
    ...
    void ignoresDependenciesOfBuildPlugins() {
        ...
        assertThat(pom.dependencies().get(0).artifactId()).isEqualTo("adventure-api");
    }
    ...
    void ignoresCommentedOutDependencies() {
        ...
        assertThat(pom.dependencies()).hasSize(1);
        assertThat(pom.dependencies().get(0).groupId()).isEqualTo("real");
    }
    ...
    void separatesManagedImportsFromDirectDependencies() {
        ...
        assertThat(pom.managed().get(0).isBomImport()).isTrue();
        assertThat(pom.dependencies()).hasSize(1);
        assertThat(pom.dependencies().get(0).version())
